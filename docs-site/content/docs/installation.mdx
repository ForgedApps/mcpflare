---
title: Installation
description: Get started with MCPflare using the VS Code extension or npx command.
---
...
Or install directly from the [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=forgedapps.mcpflare) or [Open VSX Registry](https://open-vsx.org/extension/forgedapps/mcpflare).
...
<Tabs items={['One-Click Install', 'Manual Configuration']}>
  <Tab value="One-Click Install">
    ...
    [![Install MCP Server](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en/install-mcp?name=mcpflare&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsIm1jcGd1YXJkIl19)
  </Tab>
  <Tab value="Manual Configuration">
    ...
    **Configuration file locations:**
    ...
    <Callout type="info" title="Multiple Paths Supported">
      MCPflare checks multiple locations for each IDE in priority order. The paths shown above are the primary locations, but fallback paths are also supported.
    </Callout>
  </Tab>
</Tabs>
...
<Callout type="warning" title="Don't Remove MCP Entries">
...
- [Learn how MCPflare works](/docs/how-it-works)
