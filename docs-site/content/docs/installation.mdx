  ...
  <Tab value="Manual Configuration">
    ...
    **Configuration file locations:**
    ...
    <Callout type="info" title="Multiple Paths Supported">
      MCP Guard checks multiple locations for each IDE in priority order. The paths shown above are the primary locations, but fallback paths are also supported.
    </Callout>
  </Tab>
</Tabs>
